...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        Metaverse is the New thing in the Future, where
        you can enjoy the virtual world by feeling
        like its really real, you can feel what you
        feel in this etaverse world, beacouse ths is 
        really the madness of metaverse of today,
        using only VR devices you can easily explore 
